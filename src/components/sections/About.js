            ...
            <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-12">
                ...
                <div className="relative group w-full max-w-[300px] mx-auto md:mx-0">
                    <div className="relative z-10 w-full h-auto bg-green rounded transition-all duration-300 group-hover:bg-transparent">
                        <img href="https://github.com/ayushsinha0804/Portfolio/blob/5db540fc621789696d08fb4415a9a5944f7bff7e/src/components/sections/me.jpg" alt="Headshot" className="w-full h-auto rounded mix-blend-multiply grayscale hover:grayscale-0 transition-all duration-500" />
                    </div>
